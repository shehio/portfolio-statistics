...
def get_arithmetic_return(portfolio_returns):
    ...
    return 100 * sum(map(lambda _return: _return, portfolio_returns)) / periods
...
if __name__ == '__main__':
    ...
    t_bills_start_date = datetime.date(2000, 1, 1)
    russel_start_date = datetime.date(1999, 12, 1)
    ...
    standard_deviations = \
        list(map(lambda portfolio_returns: np.std(portfolio_returns), portfolios_returns))
