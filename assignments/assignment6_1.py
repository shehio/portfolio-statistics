...
income_returns, price_returns, total_returns, new_portfolio, portfolio_values, transaction_costs, \
               weekly_fees, dividends_collection = Helpers.load_vars_from_pickle('pkls/a5.pkl')
...
Helpers.myprint([f'The cash before discounting the fee is: {round(portfolio_cash_before_fee, 2)}',
                 f'The weekly fee on: {Helpers.assignment5_end_date} is: {round(weekly_fee, 2)}, '
...
IoHelpers.write_holdings('yassers', new_portfolio, Helpers.assignment6_1_end_date)

portfolio_value_by_the_end_of_current_week = new_portfolio.get_value(Helpers.assignment6_1_end_date)
...
income_return, price_return, total_return = \
    Helpers.get_returns(new_portfolio, portfolio_values[len(portfolio_values) - 2], Helpers.assignment6_1_end_date)
...
IoHelpers.write_account_summary(
    ...
    dates=[Helpers.start_date,
           ...
           Helpers.assignment5_end_date,
           Helpers.assignment6_1_end_date],
    deposits=[Helpers.that_initial_balance, 0, 100_000, 0, 0, 0, 0],
...
Helpers.save_to_pickle(collection, 'pkls/a61.pkl')
